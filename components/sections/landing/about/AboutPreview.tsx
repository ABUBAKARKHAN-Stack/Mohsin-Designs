...
//             </p>
//             <p className="text-muted-foreground text-lg mt-4 leading-relaxed max-w-lg">
//               Since 2019, Mohsin Designs has worked with businesses across multiple industries, helping them launch, reposition, and scale with confidence. From early-stage startups to established companies, our work reflects reliability, clarity, and long-term thinking.
//             </p>
//             <p className="text-muted-foreground text-lg mt-4 leading-relaxed max-w-lg">
//               Our experience allows us to move beyond guesswork. We understand what works, what doesn’t, and how to build digital assets that remain effective as businesses grow.
//             </p>
//             <Link
//               href="/about"
//               className="inline-flex items-center gap-2 mt-8 text-foreground font-medium group"
...
//             className="flex flex-wrap gap-10 md:gap-14 pt-8 "
//           >
//             {stats.map((stat, i) => (
//               <motion.div
//                 key={i}
