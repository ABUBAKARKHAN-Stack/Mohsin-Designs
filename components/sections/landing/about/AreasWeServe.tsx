...
const AreasWeServe = () => {
  ...
  return (
    <section ref={containerRef} className="py-24 md:py-32 bg-muted/30 relative overflow-hidden">
      ...
      <motion.div 
        style={{ y: backgroundY }}
        className="absolute -bottom-20 -left-20 w-96 h-96 bg-gradient-to-br from-accent/20 to-transparent rounded-full blur-3xl"
      />
      ...
      <ContainerLayout className="relative z-10">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16">
          ...
          >
            <div className="text-center">
              <div className="text-4xl font-display font-bold text-accent">4</div>
            ...
            <div className="text-center">
              <div className="text-4xl font-display font-bold text-accent">365+</div>
        ...
        >
          <div className="p-8 md:p-10 rounded-3xl bg-gradient-to-r from-accent/20 via-primary/10 to-accent/20 border border-accent/20 backdrop-blur-sm">
