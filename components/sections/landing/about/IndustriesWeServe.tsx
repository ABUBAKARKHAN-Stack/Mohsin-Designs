...
const IndustriesWeServe = () => {
  ...
  return (
    <section ref={containerRef} className="py-24 md:py-32 relative overflow-hidden">
      ...
      <motion.div 
        style={{ y: y1 }}
        className="absolute top-20 -left-40 w-[400px] h-[400px] bg-accent/10 rounded-full blur-3xl"
      />
      <motion.div 
        style={{ y: y2 }}
        className="absolute bottom-20 -right-40 w-[500px] h-[500px] bg-primary/10 rounded-full blur-3xl"
      />
